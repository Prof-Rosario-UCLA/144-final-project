  ...
  return (
    ...
    >
      {!showWebcam && !image && (
        ...
        className="mr-[.2em] sm:px-4 sm:py-2 px-2 py-1 sm:text-lg text-sm bg-purple-300 hover:bg-purple-400 text-white font-semibold rounded-xl cursor-pointer focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors ease-linear duration-150"
      ...
      {image && (
        <>
          <img src={image} alt="Captured Image" className="rounded-lg mt-[.6em] border-[.2em] border-slate-800" />
          <button
          onClick={() => {
            setImage(null);
            setShowWebcam(true);
